...
def tecnocasa(driver):
    url_site = 'https://www.tecnocasa.es/venta/inmuebles/comunidad-de-madrid/madrid/madrid.html/pag-1'
    driver.get(url_site)
    ...
    while True:
        page+=1
        url_site = 'https://www.tecnocasa.es/venta/inmuebles/comunidad-de-madrid/madrid/madrid.html/pag-{}'.format(page)
        driver.get(url_site)
        time.sleep(random.uniform(4,6))
...
def call_all_madrid():
    ...
    try:
        print("Iniciando servihabitad")
        servihabitad(driver)
    except:
        print("---Error en servihabitad")   
    try:
        print("---Iniciando solvia")
        solvia(driver)
    except:
        print("---Error en solvia")
    try:
        print("---Iniciando haya")
        haya(driver)
    except:
        print("---Error en altamira")
    try:
        print("---Iniciando altamira")
        altamira(driver)
    except:
        print("---Error en altamira")
    #driver = uc.Chrome()
...
def add_to_csv_without_duplicates(dict_data,file_name='data/realestate_data_madrid.csv'):
