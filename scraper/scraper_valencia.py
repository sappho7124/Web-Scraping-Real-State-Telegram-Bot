...
def tecnocasa(driver):
    url_site = 'https://www.tecnocasa.es/venta/inmuebles/comunidad-valenciana/valencia/valencia.html/pag-1'
    driver.get(url_site)
    time.sleep(random.uniform(4, 6))
    cookies = driver.find_element(By.XPATH, "/html/body/div[3]/button[1]")
    cookies.click()
    time.sleep(random.uniform(4, 6))
    stop = BeautifulSoup(driver.page_source, 'html.parser').find_all(
        'div', class_='estate-card')
    page = 0
    while True:
        page += 1
        url_site = 'https://www.tecnocasa.es/venta/inmuebles/comunidad-valenciana/valencia/valencia.html/pag-{}'.format(
            page)
        driver.get(url_site)
        time.sleep(random.uniform(4, 6))
        ...
        for listing in listings_list:
            ...
            try:
                ...
                pass
            data = {'precio': precio.strip(), 'metraje': metraje.strip(
            ), 'lugar': lugar.text.strip(), 'titulo': titulo.text.strip(), 'url': url['href']}
...
def servihabitad(driver):
    ...
    cookies = driver.find_element(
        By.XPATH, '//*[@id="p_p_id_servihavitatretailmodalcondiciones_WAR_servihavitatretailmodalcondicionesportlet_"]/div/div/div[1]/div/button[1]')
    cookies.click()
    page = 0
    while True:
        page += 1
        url_site = "https://www.servihabitat.com/es/venta/vivienda/madrid-areametropolitanamadrid-madrid?lc=madrid-areametropolitanamadrid-madarganzuela_atocha,madrid-areametropolitanamadrid-madcanillejas,madrid-areametropolitanamadrid-madcarabanchel,madrid-areametropolitanamadrid-madcarabanchel_abrantes,madrid-areametropolitanamadrid-madcentro,madrid-areametropolitanamadrid-madchamartin,madrid-areametropolitanamadrid-madchamberi,madrid-areametropolitanamadrid-madciudadlineal,madrid-areametropolitanamadrid-madfuencarral,madrid-areametropolitanamadrid-madhortaleza,madrid-areametropolitanamadrid-madhortaleza_sanchinarro,madrid-areametropolitanamadrid-madlalatina,madrid-areametropolitanamadrid-madlalatina_aguilas,madrid-areametropolitanamadrid-madmoncloa_valdezarza,madrid-areametropolitanamadrid-madpuentedevallecas,madrid-areametropolitanamadrid-madsalamanca,madrid-areametropolitanamadrid-madtetuan,madrid-areametropolitanamadrid-madusera,madrid-areametropolitanamadrid-madvicalvaro,madrid-areametropolitanamadrid-madvilladevallecas,madrid-areametropolitanamadrid-madvillaverde&p={}".format(
            page)
        driver.get(url_site)
        time.sleep(random.uniform(1, 3))
        bsjob = BeautifulSoup(driver.page_source, "html.parser")
        ...
        for listing in listings_list:
            ...
            url_raw = listing.find(
                'a', class_="features vivienda", onclick=True)
            ...
            try:
                ...
                pass
            data = {'precio': precio.strip(), 'metraje': metraje.strip(
            ), 'lugar': lugar, 'titulo': titulo.text.strip(), 'url': url}
            if precio is not None and metraje is not None and titulo is not None and url is not None:
                add_to_csv_without_duplicates(data)
            else:
                print("No se ha podido añadir")
...
def solvia(driver):
    ...
    time.sleep(1)
    cookies = driver.find_element(
        By.XPATH, '//*[@id="solvia-app"]/solvia-cookies-policy/solvia-simple-modal[1]/div/div/div[2]/a[1]')
    cookies.click()
    page = -1
    while True:
        page += 1
        url_site = "https://www.solvia.es/es/comprar/viviendas/madrid?numeroPagina={}".format(
            page)
        driver.get(url_site)
        time.sleep(5)
        bsjob = BeautifulSoup(driver.page_source, "html.parser")
        ...
        for listing in listings_list:
            ...
            atributos = listing.find(
                'div', class_='u__pl--0 tags-container border-bottom-grey col-8 col-xs-12 d-flex flex-row align-items-baseline u__pb--sm')
            ...
            try:
                ...
                pass
            data = {'precio': precio.strip(), 'metraje': metraje.strip(
            ), 'lugar': lugar.text.strip(), 'titulo': titulo.text.strip(), 'url': url}
            if precio is not None and metraje is not None and titulo is not None and url is not None:
                add_to_csv_without_duplicates(data)
            else:
                print("No se ha podido añadir")
...
def haya(driver):
    ...
    while True:
        page += 1
        url_site = "https://www.haya.es/bbva/viviendas/madrid/?p={}".format(
            page)
        driver.get(url_site)
        time.sleep(random.uniform(2, 6))
        bsjob = BeautifulSoup(driver.page_source, "html.parser")
        listings_list = bsjob.find_all(
            'div', class_='h-100 d-md-flex flex-column align-items-end')
        ...
        for listing in listings_list:
            ...
            lugar = None
            title_and_url_raw = listing.find(
                'a', class_='text-black', title=True, href=True)
            ...
            try:
                ...
                pass
            data = {'precio': precio, 'metraje': metraje.text.strip(
            ), 'lugar': lugar, 'titulo': titulo, 'url': url}
...
def altamira(driver):
    driver.get(
        "https://www.altamirainmuebles.com/resultados/venta/pisos-y-casas/madrid/40p4167754lm3p7037902z13")
    time.sleep(1)
    cookies = driver.find_element(
    ...
    for listing in listings_list:
        ...
        data = {'precio': precio, 'metraje': metraje,
                'lugar': lugar, 'titulo': titulo, 'url': url}
        if precio is not None and metraje is not None and titulo is not None and url is not None:
            add_to_csv_without_duplicates(data)
        else:
...
def idealista(driver):
    driver.get(
        "https://www.idealista.com/venta-viviendas/madrid-provincia/pagina-1.htm")
    time.sleep(random.uniform(2, 3))
    cookies = driver.find_element(
        By.XPATH, '/html/body/div[1]/div/div/div/div/div[2]/button[2]')
    cookies.click()
    time.sleep(random.uniform(5, 8))
    page = 1
    while True:
        page += 1
        url_site = "https://www.idealista.com/venta-viviendas/madrid-provincia/pagina-{}.htm".format(
            page)
        time.sleep(random.uniform(5, 8))
        bsjob = BeautifulSoup(driver.page_source, "html.parser")
...
def fotocasa(driver):
    driver.get(
        "https://www.fotocasa.es/es/comprar/viviendas/madrid-provincia/todas-las-zonas/l/1")
    time.sleep(random.uniform(1, 5))
    cookies = driver.find_element(
        By.XPATH, '//*[@id="App"]/div[2]/div/div/div/footer/div/button[2]')
    cookies.click()
    time.sleep(random.uniform(5, 8))
    page = 1
    while True:
        ...
        for listing in listings_list:
            ...
            metraje = listing.find(
                'span', class_="re-CardFeaturesWithIcons-feature-icon re-CardFeaturesWithIcons-feature-icon--surface")
            lugar = None
            titulo = listing.find(
                'span', class_="re-CardTitle re-CardTitle--big")
            url = listing.find(
                'a', class_="re-CardPackPremium-info-container", href=True)
            try:
                precio = precio.text.replace('€', '')
                precio = precio.strip()
                metraje = metraje.text.replace('m²', '')
                ...
                pass
            data = {'precio': precio, 'metraje': metraje, 'lugar': lugar,
                    'titulo': titulo.text.strip(), 'url': url['href']}
            if precio is not None and metraje is not None and titulo is not None and url is not None:
                add_to_csv_without_duplicates(data)
            else:
                print("No se ha podido añadir")
                print(data)
        url_site = 'https://www.fotocasa.es/es/comprar/viviendas/madrid-provincia/todas-las-zonas/l/{}'.format(
            page)
        driver.get(url_site)


def call_all_valencia():
...
def add_to_csv_without_duplicates(dict_data, file_name='data/realestate_data_valencia.csv'):
